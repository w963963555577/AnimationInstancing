...
{
    [InitializeOnLoad]
    internal class ZDCharacter_AnimationInstancing : BaseFuncyShaderGUI
    {
        static List<Material> zdCharacterMaterials = new List<Material>();
        static ZDCharacter_AnimationInstancing()
        {
            EditorApplication.delayCall += () => {
                EditorApplication.update += () => {
                    zdCharacterMaterials = Resources.FindObjectsOfTypeAll<Material>().ToList().FindAll(m => m.shader == Shader.Find("ZDShader/LWRP/Character(AnimationInstancing)"));
                };
            };
        }

        public MaterialProperty vertexDataMap { get; set; }
        ...
        {
            vertexDataMap = FindProperty("_VertexDataMap", props);
        ...
        public virtual void BaseArea(Material mat)
        {
            ...
            materialEditor.TexturePropertySingleLine(vertexDataMap.displayName.ToGUIContent(), vertexDataMap);
